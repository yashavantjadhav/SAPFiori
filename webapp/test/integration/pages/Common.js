sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("Order/com/Order_Master/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("Order.com.Order_Master.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["Order/com/Order_Master/localService/mockserver"], function (mockserver) {
